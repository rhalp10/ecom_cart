...
<br>
<div class="container">  
<h1 style="background-color: white; padding: 5px; border-radius: 5px;  box-shadow: 5px 5px 5px grey;">LATEST PRODUCTS</h1>  
  <div class="row">
    <?php 
         ...
         <div class="col-sm-4">
          <div class="panel panel-primary">
            ...
            <div class="panel-footer">
              ...
              <div class="cart">
                <input type="submit" value="Add to Cart" class="button" name="addCart">
              </div>
              </form>
            </div>
          </div>
